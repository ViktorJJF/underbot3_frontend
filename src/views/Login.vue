                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mb-0">
                                            <button class="btn btn-primary btn-block" type="submit" @click="login"> Log In
                                            </button>
                                        </div>
...
const user = ref<{ email: string, password: string }>({ email: '', password: '' })
